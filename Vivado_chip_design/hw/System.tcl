...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xczu67dr-fsve1156-2-i
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {500000000.0} \
   ] $adc0_clk

  set adc0_clk_1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 adc0_clk_1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {500000000.0} \
   ] $adc0_clk_1

  set adc0_clk_2 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 adc0_clk_2 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {500000000.0} \
   ] $adc0_clk_2
  ...
  # Create instance: adc1_clk_wiz, and set properties
  set adc1_clk_wiz [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 adc1_clk_wiz ]
  set_property -dict [list \
    CONFIG.CLKIN1_JITTER_PS {160.0} \
    CONFIG.CLKOUT1_DRIVES {BUFGCE} \
    CONFIG.CLKOUT1_JITTER {139.999} \
  ...
  # Create instance: dac0_clk_wiz1, and set properties
  set dac0_clk_wiz1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 dac0_clk_wiz1 ]
  set_property -dict [list \
  ...
  # Create instance: dac_valid_gating_0, and set properties
  set block_name dac_valid_gating
  set block_cell_name dac_valid_gating_0
  if { [catch {set dac_valid_gating_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dac_valid_gating_0 eq "" } {
  ...
  set_property -dict [list \
    ...
    CONFIG.ADC1_Outclk_Freq {62.500} \
    CONFIG.ADC1_PLL_Enable {true} \
    CONFIG.ADC1_Sampling_Rate {0.5} \
    ...
    CONFIG.DAC0_Outclk_Freq {62.500} \
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {##############I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0#############PMU GPO 0#PMU GPO 1#PMU GPO 2#PMU GPO 3#PMU GPO 4#PMU GPO 5###############USB 0#USB 0#USB 0#USB 0#USB\
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
    CONFIG.PSU_MIO_TREE_SIGNALS {##############scl_out#sda_out#scl_out#sda_out#rxd#txd#############gpo[0]#gpo[1]#gpo[2]#gpo[3]#gpo[4]#gpo[5]###############ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out}\
\
...
\
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/s00_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m10_axis [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m10_axis]
  ...
  connect_bd_net -net adc1_clk_out [get_bd_pins adc1_clk_wiz/clk_out1] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins rst_ps8_0_99M2/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net axis_data_fifo_0_almost_full [get_bd_pins axis_data_fifo_0/almost_full] [get_bd_pins dac_valid_gating_0/fifo_full]
  connect_bd_net -net axis_data_fifo_0_m_axis_tdata [get_bd_pins axis_data_fifo_0/m_axis_tdata] [get_bd_pins usp_rf_data_converter_0/s00_axis_tdata]
  connect_bd_net -net axis_data_fifo_0_m_axis_tlast [get_bd_pins axis_data_fifo_0/m_axis_tlast] [get_bd_pins dac_valid_gating_0/fifo_m_axis_tlast]
  connect_bd_net -net axis_data_fifo_0_m_axis_tvalid [get_bd_pins axis_data_fifo_0/m_axis_tvalid] [get_bd_pins dac_valid_gating_0/fifo_m_axis_tvalid]
  connect_bd_net -net dac0_clk_out [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins dac0_clk_wiz1/clk_out1] [get_bd_pins dac_valid_gating_0/clk] [get_bd_pins rst_ps8_0_99M1/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk]
  connect_bd_net -net dac0_clk_wiz1_locked [get_bd_pins dac0_clk_wiz1/locked] [get_bd_pins rst_ps8_0_99M1/ext_reset_in]
  connect_bd_net -net dac0_clk_wiz_locked [get_bd_pins adc1_clk_wiz/locked] [get_bd_pins rst_ps8_0_99M2/ext_reset_in]
  connect_bd_net -net dac_valid_gating_0_tready [get_bd_pins axis_data_fifo_0/m_axis_tready] [get_bd_pins dac_valid_gating_0/tready]
  connect_bd_net -net dac_valid_gating_0_tvalid [get_bd_pins dac_valid_gating_0/tvalid] [get_bd_pins usp_rf_data_converter_0/s00_axis_tvalid]
  connect_bd_net -net rst_ps8_0_99M1_peripheral_aresetn [get_bd_pins dac_valid_gating_0/reset_n] [get_bd_pins rst_ps8_0_99M1/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn]
  connect_bd_net -net rst_ps8_0_99M2_peripheral_aresetn [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins rst_ps8_0_99M2/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/m1_axis_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc1 [get_bd_pins adc1_clk_wiz/clk_in1] [get_bd_pins usp_rf_data_converter_0/clk_adc1]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_pins dac0_clk_wiz1/clk_in1] [get_bd_pins usp_rf_data_converter_0/clk_dac0]
  connect_bd_net -net usp_rf_data_converter_0_s00_axis_tready [get_bd_pins dac_valid_gating_0/dac_s_axis_tready] [get_bd_pins usp_rf_data_converter_0/s00_axis_tready]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
