...
#
# create_project.tcl: Tcl script for re-creating project 'TFM_DP_part'
#
# Generated by Vivado on Wed Jul 08 19:55:16 +0200 2026
...
#
#    "F:/ALEX/UNIVERSIDAD/TFM_Worskpace/Vivado_dataproc_design/hw/TFM_DP_part.srcs/constrs_1/new/ila.xdc"
#    "F:/ALEX/UNIVERSIDAD/TFM_Worskpace/Vivado_dataproc_design/hw/TFM_DP_part.srcs/utils_1/imports/synth_1/system1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/hw/TFM_DP_part.srcs/constrs_1/new/ila.xdc"]"\
 "[file normalize "$origin_dir/hw/TFM_DP_part.srcs/utils_1/imports/synth_1/system1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "TFM_DP_part"
...
set_property -name "board_part_repo_paths" -value "C:/Users/Alex/AppData/Roaming/Xilinx/Vivado/2022.2/xhub/board_store/xilinx_board_store" -objects $obj
...
set_property -name "top" -value "system1_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/hw/TFM_DP_part.srcs/constrs_1/new/ila.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/ila.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *new/ila.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/ila.xdc]" -objects $obj
...
set file "synth_1/system1_wrapper.dcp"
...
# Proc to create BD system1
proc cr_bd_system1 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name system1
  ...
  set_property -dict [list \
    ...
    CONFIG.C_SLOT_3_AXI_AR_SEL_DATA {0} \
    CONFIG.C_SLOT_3_AXI_AR_SEL_TRIG {0} \
    ...
    CONFIG.C_SLOT_3_AXI_R_SEL_DATA {0} \
    CONFIG.C_SLOT_3_AXI_R_SEL_TRIG {0} \
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {##################################UART 0#UART 0#################USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0##############} \
    CONFIG.PSU_MIO_TREE_SIGNALS {##################################rxd#txd#################ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]##############}\
\
...
\
  ...
  connect_bd_intf_net -intf_net axi_M_DMA_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_M_DMA_MM2S] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_M_DMA_MM2S]
  connect_bd_intf_net -intf_net axi_M_DMA_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_M_DMA_S2MM] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_M_DMA_S2MM]
  ...
  connect_bd_intf_net -intf_net axis_MM2S_to_S_FIFO [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_MM2S_to_S_FIFO] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_MM2S_to_S_FIFO]
  connect_bd_intf_net -intf_net axis_M_fifo_to_S_S2MM [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_M_fifo_to_S_S2MM] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_M_fifo_to_S_S2MM]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets s2mm_introut]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  exclude_bd_addr_seg -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg]
...
# End of cr_bd_system1()
cr_bd_system1 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files system1.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files system1.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse system1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/hw/TFM_DP_part.gen/sources_1/bd/system1/hdl/system1_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse system1.bd] -top]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu3eg-sfva625-1-i -flow {Vivado Synthesis 2022} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu3eg-sfva625-1-i -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
